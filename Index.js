...
function wszystkoGotowe(){
    ...
    function start()
    {
        ...
        games.push(new AddGame(element("x"), element("y"), "Images/NowaGra.png", "pozostałe strony/MyDreamGame/MyDreamGame.html", elementTekstu("x"), elementTekstu("y"), "MyDreamGame", "body"));
